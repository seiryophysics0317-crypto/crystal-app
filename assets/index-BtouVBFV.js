...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ps(e,t,n){let r=new Float32Array(bs),i=new q(0,1,0);return new no({name:`SphericalGaussianBlur`,defines:{n:bs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ls(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fs(){return new no({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ls(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Is(){return new no({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ls(),fragmentShader:`
	...
	`}var Rs=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new yi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,document.body.appendChild(ad);var od=document.getElementById(`info`),sd=document.getElementById(`slice-ui`);document.getElementById(`type-bcc`).onclick=()=>{$u=`bcc`,Jd(td)},document.getElementById(`type-fcc`).onclick=()=>{$u=`fcc`,Jd(td)},document.getElementById(`type-hcp`).onclick=()=>{$u=`hcp`,Jd(td)},document.getElementById(`mode-full`).onclick=()=>Jd(`full`),document.getElementById(`mode-unit`).onclick=()=>Jd(`unit`),document.getElementById(`mode-cut`).onclick=()=>Jd(`cut`),document.getElementById(`mode-slice`).onclick=()=>Jd(`slice`),document.getElementById(`mode-full-slice`).onclick=()=>Jd(`full-slice`),document.getElementById(`angle-x`).oninput=e=>{nd=Number(e.target.value),cd(),ld()},document.getElementById(`angle-y`).oninput=e=>{rd=Number(e.target.value),cd(),ld()},document.getElementById(`offset`).oninput=e=>{id=Number(e.target.value),cd(),ld()};function cd(){document.getElementById(`angle-x-value`).textContent=nd,document.getElementById(`angle-y-value`).textContent=rd,document.getElementById(`offset-value`).textContent=id.toFixed(2)}function ld(){td===`slice`&&Kd(),td===`full-slice`&&qd()}function ud(e,t){let n=document.getElementById(e);for(let e=-90;e<=90;e+=15){let r=document.createElement(`button`);r.textContent=String(e),r.style.fontSize=`11px`,r.style.padding=`2px 5px`,r.onclick=()=>{t===`x`?(nd=e,document.getElementById(`angle-x`).value=e):(rd=e,document.getElementById(`angle-y`).value=e),cd(),ld()},n.appendChild(r)}}ud(`angle-x-buttons`,`x`),ud(`angle-y-buttons`,`y`);function dd(){return $u===`bcc`?`体心立方格子 BCC`:$u===`fcc`?`面心立方格子 FCC`:`六方最密充填構造 HCP`}function fd(){return{side:1,r:1/2,c:Math.sqrt(8/3)*1}}function pd(){return $u===`bcc`?Math.sqrt(3)*Xu/4:$u===`fcc`?Math.sqrt(2)*Xu/4:fd().r}function md(){return $u===`bcc`?2:$u===`fcc`?4:6}function hd(){if($u===`hcp`)return Math.PI/(3*Math.sqrt(2));let e=pd();return md()*(4/3)*Math.PI*e**3/Xu**3}function gd(){return $u===`bcc`?`BCC：4r = √3a`:$u===`fcc`?`FCC：4r = √2a`:`HCP：ABAB型、理想比 c/a = √(8/3)、充填率 ≒ 74.0%`}function _d(){for(let e of ed)Gu.remove(e),e.geometry&&e.geometry.dispose(),e.material&&(Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose()),e.children&&e.children.forEach(e=>{e.geometry&&e.geometry.dispose(),e.material&&(Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose())});ed=[]}function vd(e){return Gu.add(e),ed.push(e),e}function yd(e=[]){return new io({color:Qu,roughness:.35,metalness:.02,side:2,clippingPlanes:e,polygonOffset:!0,polygonOffsetFactor:1,polygonOffsetUnits:1})}function bd(){return new oi({color:1118481})}function xd(e=Xu){vd(new vi(new ki(new Ci(e,e,e)),bd()))}function Sd(e,t,n,r,i=[]){let a=new Jr(new qa(r,96,64),yd(i));a.position.set(e,t,n),vd(a)}function Cd(){return[new ti(new q(1,0,0),Zu),new ti(new q(-1,0,0),Zu),new ti(new q(0,1,0),Zu),new ti(new q(0,-1,0),Zu),new ti(new q(0,0,1),Zu),new ti(new q(0,0,-1),Zu)]}function wd(e=0,t=0,n=0){let{side:r,c:i}=fd(),a=[];a.push(new ti(new q(0,0,1),i/2-n)),a.push(new ti(new q(0,0,-1),i/2+n));let o=r*Math.sqrt(3)/2;for(let n=0;n<6;n++){let r=n*Math.PI/3+Math.PI/6,i=new q(-Math.cos(r),-Math.sin(r),0),s=o+i.x*e+i.y*t;a.push(new ti(i,s))}return a}function Td(e=0,t=0,n=0){let r=[];for(let i of[-1,Zu])for(let a of[-1,Zu])for(let o of[-1,Zu])r.push(new q(i+e,a+t,o+n));return r.push(new q(e,t,n)),r}function Ed(e=0,t=0,n=0){let r=[];for(let i of[-1,Zu])for(let a of[-1,Zu])for(let o of[-1,Zu])r.push(new q(i+e,a+t,o+n));return r.push(new q(Zu+e,0+t,0+n)),r.push(new q(-1+e,0+t,0+n)),r.push(new q(0+e,Zu+t,0+n)),r.push(new q(0+e,-1+t,0+n)),r.push(new q(0+e,0+t,Zu+n)),r.push(new q(0+e,0+t,-1+n)),r}function Dd(e=0,t=0,n=0){let{side:r,c:i}=fd(),a=[],o=-i/2,s=i/2;for(let i=0;i<6;i++){let c=Math.PI/3*i,l=r*Math.cos(c),u=r*Math.sin(c);a.push(new q(l+e,u+t,o+n)),a.push(new q(l+e,u+t,s+n))}a.push(new q(e,t,o+n)),a.push(new q(e,t,s+n));let c=r/Math.sqrt(3);for(let r=0;r<3;r++){let i=Math.PI/6+r*(2*Math.PI/3),o=c*Math.cos(i),s=c*Math.sin(i);a.push(new q(o+e,s+t,0+n))}return a}function Od(e=0,t=0,n=0){return $u===`bcc`?Td(e,t,n):$u===`fcc`?Ed(e,t,n):Dd(e,t,n)}function kd(e=0,t=0,n=0,r=[]){let i=pd();for(let a of Od(e,t,n))Sd(a.x,a.y,a.z,i,r)}function Ad(e=0,t=0,n=0){let{side:r,c:i}=fd(),a=[],o=[];for(let s=0;s<6;s++){let c=Math.PI/3*s;a.push(new q(r*Math.cos(c)+e,r*Math.sin(c)+t,-i/2+n)),o.push(new q(r*Math.cos(c)+e,r*Math.sin(c)+t,i/2+n))}let s=[];for(let e=0;e<6;e++)s.push(a[e],a[(e+1)%6]),s.push(o[e],o[(e+1)%6]),s.push(a[e],o[e]);vd(new vi(new Tr().setFromPoints(s),bd()))}function jd(e=0,t=0,n=0){let{side:r,c:i}=fd(),a=new Ir({color:16769154,transparent:!0,opacity:.12,side:2,depthWrite:!1}),o=new oa;for(let e=0;e<6;e++){let t=Math.PI/3*e,n=r*Math.cos(t),i=r*Math.sin(t);e===0?o.moveTo(n,i):o.lineTo(n,i)}o.closePath();let s=new Ga(o),c=new Jr(s,a.clone());c.position.set(e,t,-i/2+n),vd(c);let l=new Jr(s,a.clone());l.position.set(e,t,i/2+n),vd(l);for(let o=0;o<6;o++){let s=Math.PI/3*o,c=Math.PI/3*((o+1)%6),l=new q(r*Math.cos(s),r*Math.sin(s),-i/2),u=new q(r*Math.cos(c),r*Math.sin(c),-i/2),d=new q(r*Math.cos(c),r*Math.sin(c),i/2),f=new q(r*Math.cos(s),r*Math.sin(s),i/2),p=new Float32Array([l.x,l.y,l.z,u.x,u.y,u.z,d.x,d.y,d.z,l.x,l.y,l.z,d.x,d.y,d.z,f.x,f.y,f.z]),m=new Tr;m.setAttribute(`position`,new ur(p,3)),m.computeVertexNormals();let h=new Jr(m,a.clone());h.position.set(e,t,n),vd(h)}}function Md(e,t,n,r,i=[],a=1){if(n<=.001)return;let o=new Jr(new wi(n,128),new Ir({color:r,transparent:a<1,opacity:a,side:2,clippingPlanes:i,polygonOffset:!0,polygonOffsetFactor:-3,polygonOffsetUnits:-3})),s=new q(0,0,1),c=new Et().setFromUnitVectors(s,t.clone().normalize());o.quaternion.copy(c),o.position.copy(e.clone().add(t.clone().multiplyScalar(.006))),o.renderOrder=3,vd(o)}function Nd(e,t,n,r){for(let i of n){let a=i.distanceToPoint(e);if(Math.abs(a)<t){let o=Math.sqrt(t*t-a*a);Md(e.clone().add(i.normal.clone().multiplyScalar(-a)),i.normal,o,r,n,1)}}}function Pd(e,t,n,r){let i=[],a=[];for(let a=0;a<=32;a++){let o=a/32*Math.PI/2;for(let a=0;a<=32;a++){let s=a/32*Math.PI/2,c=t*e*Math.sin(o)*Math.cos(s),l=n*e*Math.sin(o)*Math.sin(s),u=r*e*Math.cos(o);i.push(c,l,u)}}for(let e=0;e<32;e++)for(let t=0;t<32;t++){let n=e*33+t,r=n+1,i=(e+1)*33+t,o=i+1;a.push(n,i,r),a.push(r,i,o)}let o=new Tr;return o.setAttribute(`position`,new pr(i,3)),o.setIndex(a),o.computeVertexNormals(),o}function Fd(e,t,n,r,i){let a=[0,0,0],o=[];for(let o=0;o<=48;o++){let s=o/48*Math.PI/2,c=0,l=0,u=0;t===`x`&&(l=r*e*Math.cos(s),u=i*e*Math.sin(s)),t===`y`&&(c=n*e*Math.cos(s),u=i*e*Math.sin(s)),t===`z`&&(c=n*e*Math.cos(s),l=r*e*Math.sin(s)),a.push(c,l,u)}for(let e=1;e<=48;e++)o.push(0,e,e+1);let s=new Tr;return s.setAttribute(`position`,new pr(a,3)),s.setIndex(o),s.computeVertexNormals(),s}function Id(e,t,n,r,i,a){let o=pd(),s=new Cn;s.position.set(e,t,n);let c=[new Jr(Pd(o,r,i,a),yd()),new Jr(Fd(o,`x`,r,i,a),yd()),new Jr(Fd(o,`y`,r,i,a),yd()),new Jr(Fd(o,`z`,r,i,a),yd())];for(let e of c)s.add(e);vd(s)}function Ld(e,t,n){let r=[],i=[];for(let i=0;i<=32;i++){let a=i/32*Math.PI/2;for(let i=0;i<=64;i++){let o=i/64*Math.PI*2,s=0,c=0,l=0;t===`x`&&(s=n*e*Math.cos(a),c=e*Math.sin(a)*Math.cos(o),l=e*Math.sin(a)*Math.sin(o)),t===`y`&&(c=n*e*Math.cos(a),s=e*Math.sin(a)*Math.cos(o),l=e*Math.sin(a)*Math.sin(o)),t===`z`&&(l=n*e*Math.cos(a),s=e*Math.sin(a)*Math.cos(o),c=e*Math.sin(a)*Math.sin(o)),r.push(s,c,l)}}for(let e=0;e<32;e++)for(let t=0;t<64;t++){let n=e*65+t,r=n+1,a=(e+1)*65+t,o=a+1;i.push(n,a,r),i.push(r,a,o)}let a=new Tr;return a.setAttribute(`position`,new pr(r,3)),a.setIndex(i),a.computeVertexNormals(),a}function Rd(e,t){let n=[0,0,0],r=[];for(let r=0;r<=96;r++){let i=r/96*Math.PI*2,a=0,o=0,s=0;t===`x`&&(o=e*Math.cos(i),s=e*Math.sin(i)),t===`y`&&(a=e*Math.cos(i),s=e*Math.sin(i)),t===`z`&&(a=e*Math.cos(i),o=e*Math.sin(i)),n.push(a,o,s)}for(let e=1;e<=96;e++)r.push(0,e,e+1);let i=new Tr;return i.setAttribute(`position`,new pr(n,3)),i.setIndex(r),i.computeVertexNormals(),i}function zd(e,t,n,r,i){let a=pd(),o=new Cn;o.position.set(e,t,n);let s=new Jr(Ld(a,r,i),yd()),c=new Jr(Rd(a,r),yd());o.add(s),o.add(c),vd(o)}function Bd(){if($u===`bcc`){Sd(0,0,0,pd());for(let e of[-1,Zu])for(let t of[-1,Zu])for(let n of[-1,Zu])Id(e,t,n,e>0?-1:1,t>0?-1:1,n>0?-1:1);return}if($u===`fcc`){for(let e of[-1,Zu])for(let t of[-1,Zu])for(let n of[-1,Zu])Id(e,t,n,e>0?-1:1,t>0?-1:1,n>0?-1:1);zd(Zu,0,0,`x`,-1),zd(-1,0,0,`x`,1),zd(0,Zu,0,`y`,-1),zd(0,-1,0,`y`,1),zd(0,0,Zu,`z`,-1),zd(0,0,-1,`z`,1);return}let e=wd();jd(),kd(0,0,0,e);for(let t of Dd())Nd(t,pd(),e,Qu)}function Vd(){let e=new q(0,0,1);return e.applyAxisAngle(new q(1,0,0),Tt.degToRad(nd)),e.applyAxisAngle(new q(0,1,0),Tt.degToRad(rd)),e.normalize(),new ti(e,-id)}function Hd(e,t=7){let n=new Jr(new Wa(t,t),new Ir({color:16732754,transparent:!0,opacity:.12,side:2,depthWrite:!1,polygonOffset:!0,polygonOffsetFactor:5,polygonOffsetUnits:5})),r=new q(0,0,1),i=new Et().setFromUnitVectors(r,e.normal.clone().normalize());n.quaternion.copy(i),n.position.copy(e.normal.clone().multiplyScalar(-e.constant-.01)),n.renderOrder=-1,vd(n)}function Ud(){if(_d(),sd.style.display=`none`,$u===`hcp`){let{side:e}=fd(),t=e*1.5,n=e*Math.sqrt(3);for(let e of[-2,-1,0,1,2])for(let r of[-2,-1,0,1,2])kd(e*t,r*n+e%2*n/2,0);od.innerHTML=`
      <b>${dd()}：結晶構造いっぱい版</b><br>
      六角形の単位格子がくり返し並ぶ様子です。<br>
      ${gd()}
    `;return}let e=[-2,0,2];for(let t of e)for(let n of e)for(let r of e)kd(t,n,r);od.innerHTML=`
    <b>${dd()}：結晶構造いっぱい版</b><br>
    単位格子がくり返し並ぶ様子です。<br>
    ${gd()}
  `}function Wd(){if(_d(),sd.style.display=`none`,$u===`hcp`){Ad(),kd(),od.innerHTML=`
      <b>${dd()}：単位格子版</b><br>
      ABAB型に粒子が積み重なる構造です。<br>
      ${gd()}
    `;return}xd(Xu),kd(),od.innerHTML=`
    <b>${dd()}：単位格子版</b><br>
    粒子を切らずに表示。<br>
    ${gd()}
  `}function Gd(){_d(),sd.style.display=`none`,$u===`hcp`?Ad():xd(Xu),Bd();let e=``;e=$u===`bcc`?`角：8 × 1/8 = 1<br>体心：1 × 1 = 1<br>合計：2個`:$u===`fcc`?`角：8 × 1/8 = 1<br>面心：6 × 1/2 = 3<br>合計：4個`:`六角柱単位格子内の粒子数：6個<br>ABAB型の最密充填`,od.innerHTML=`
    <b>${dd()}：単位格子カット版</b><br>
    ${e}<br>
    充填率：約 ${(hd()*100).toFixed(1)}%
  `}function Kd(){_d(),sd.style.display=`block`;let e=Vd(),t;$u===`hcp`?(t=wd(),Ad()):(t=Cd(),xd(Xu));let n=[...t,e];kd(0,0,0,n);for(let e of Od())Nd(e,pd(),n,Qu);Hd(e,$u===`hcp`?3.8:3.4),od.innerHTML=`
    <b>${dd()}：単位格子 任意断面</b><br>
    単位格子カット版を任意角度で切っています。<br>
    充填率：約 ${(hd()*100).toFixed(1)}%
  `}function qd(){_d(),sd.style.display=`block`;let e=Vd();if($u===`hcp`){let{side:t}=fd(),n=t*1.5,r=t*Math.sqrt(3);for(let t of[-2,-1,0,1,2])for(let i of[-2,-1,0,1,2]){let a=t*n,o=i*r+t%2*r/2;kd(a,o,0,[e]);for(let t of Od(a,o,0))Nd(t,pd(),[e],Qu)}Hd(e,8),od.innerHTML=`
      <b>${dd()}：結晶いっぱい 任意断面</b><br>
      HCPの繰り返し構造全体を任意角度で切っています。<br>
      15度ボタンで角度をすぐ変更できます。
    `;return}let t=[-2,0,2];for(let n of t)for(let r of t)for(let i of t){kd(n,r,i,[e]);for(let t of Od(n,r,i))Nd(t,pd(),[e],Qu)}Hd(e,8),od.innerHTML=`
    <b>${dd()}：結晶いっぱい 任意断面</b><br>
    繰り返し構造全体を任意角度で切っています。<br>
    15度ボタンで角度をすぐ変更できます。
  `}function Jd(e){td=e,e===`full`&&Ud(),e===`unit`&&Wd(),e===`cut`&&Gd(),e===`slice`&&Kd(),e===`full-slice`&&qd()}Jd(td),window.addEventListener(`resize`,()=>{Ku.aspect=innerWidth/innerHeight,Ku.updateProjectionMatrix(),qu.setSize(innerWidth,innerHeight)});function Yd(){requestAnimationFrame(Yd),Ju.update(),qu.render(Gu,Ku)}Yd();